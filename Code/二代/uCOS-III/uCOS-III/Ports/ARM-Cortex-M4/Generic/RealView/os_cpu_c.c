...
void  OS_CPU_SysTickInit (CPU_INT32U  cnts)
{
    ...
    prio    &= DEF_BIT_FIELD(24, 0);                        /* clear high 8bit         added by eric2013              */
    prio   |= DEF_BIT_MASK(OS_CPU_CFG_SYSTICK_PRIO, 24);    /* |(or) high 8bit OS_CPU_CFG_SYSTICK_PRIO  added by eric2013 */
